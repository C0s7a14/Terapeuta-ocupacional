...
type Tab = "overview" | "record" | "evolutions" | "diary" | "documents";
...
export function PatientDetails() {
  ...
  const tabs: { key: Tab; label: string }[] = [{ key: "overview", label: "Visão geral" }, { key: "record", label: "Prontuário" }, { key: "evolutions", label: "Evoluções" }, { key: "diary", label: "Diário Terapêutico" }, { key: "documents", label: "Documentos" }];
  return (
    <>
      ...
      <div className="card mb-6 overflow-hidden bg-gradient-to-br from-white via-white to-rosewood-50/70">
      ...
      {tab === "diary" && <PatientDiary patientName={patient.name} />}
